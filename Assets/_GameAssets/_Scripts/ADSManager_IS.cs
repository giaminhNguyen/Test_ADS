...
public class ADSManager_IS : MonoBehaviour
{
    ...
    public        bool          HasRewardedVideo => IronSource.Agent.isRewardedVideoAvailable();
    public        bool          HasInterstitial  => _interstitialAd?.IsAdReady() ?? false;
    ...
    public async void DelayShowRewardedVideo(Action actionDone = null,Action actionFailed = null)
    {
        await Task.Delay(delayTimeShowRewardedMs);
        ShowRewardedVideo(actionDone,actionFailed);
    }
    ...
    public async void DelayShowInterstitial(Action actionDone = null,Action actionFailed = null)
    {
        await Task.Delay(delayTimeShowInterstitialMs);
        ShowInterstitial(actionDone,actionFailed);
    }
